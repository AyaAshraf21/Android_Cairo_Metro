...
public class StationsUtil {
    ...
    static {
        ...
        adjacentStationsMapArabic.put("ناصر", new String[]{"عرابي", "السادات", "ماسپيرو", "العتبة"});
        ...
        adjacentStationsMapArabic.put("ماسپيرو", new String[]{"ناصر", "صفاء حجازي"});
        adjacentStationsMapArabic.put("صفاء حجازي", new String[]{"ماسپيرو", "الكيت كات"});
